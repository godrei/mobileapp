    ...
    public sealed class ReportsCalendarViewModel : MvxViewModel
    {
        ...
        private void calendarDayTapped(CalendarDayViewModel tappedDay)
        {
            ...
            var startDate = new DateTimeOffset(
                startOfSelection.CalendarMonth.Year,
                startOfSelection.CalendarMonth.Month,
                startOfSelection.Day,
                0,
                0,
                0,
                TimeSpan.Zero
            ...
            var endDate = new DateTimeOffset(
                tappedDay.CalendarMonth.Year,
                tappedDay.CalendarMonth.Month,
                tappedDay.Day,
                0,
                0,
                0,
        ...
        public async override Task Initialize()
        {
            ...
            QuickSelectShortcuts = new List<CalendarBaseQuickSelectShortcut>
            {
