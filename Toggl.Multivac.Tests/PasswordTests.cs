...
namespace Toggl.Multivac.Tests
{
    public sealed class PasswordTests
    {
        public sealed class TheIsValidProperty
        {
            ...
            {
                Password.FromString(passwordString).IsValid.Should().BeFalse();
            }
            ...
            public void ReturnsTrueWhenPasswordIsLongerThan6Characters(
                string passwordString)
            {
                Password.FromString(passwordString).IsValid.Should().BeTrue();
            }
        }
        ...
        public sealed class TheToStringMethod
        {
                ...
                NonEmptyString nonEmptyString)
            {
                ...
                var password = Password.FromString(passwordString);
